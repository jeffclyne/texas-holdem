...
class Engine {
  ...
  dealHand() {
    ...
    // Blinds
    this._activePlayers[(this._dealerIndex + 1) % this._activePlayers.length]._currentBet = this._smallBlind;
    this._activePlayers[(this._dealerIndex + 2) % this._activePlayers.length]._currentBet = this._smallBlind * 2;
